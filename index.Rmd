...
# Cross-university comparisons
## Descriptives for in-state visits to public high schools

<div class="graphs-set graphs-set-all">
  <div class="comparison-wrapper desc-table">
```{r, echo=FALSE, results='asis'}
cat(paste0(readLines("assets/tables/descriptives_pubHS.htm"),collapse=" "))
```
  </div>
  <a class="btn btn-compare" href="#/`r verticalSlide`">Deep-dive results</a>
</div>
...
# Cross-university comparisons
## Descriptives for in-state visits to community colleges

<div class="graphs-set graphs-set-all">
  <div class="comparison-wrapper desc-table">
```{r, echo=FALSE, results='asis'}
cat(paste0(readLines("assets/tables/descriptives_CC.htm"),collapse=" "))
```
  </div>
  <a class="btn btn-compare" href="#/`r verticalSlide`">Deep-dive results</a>
</div>
